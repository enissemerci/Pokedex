...
const createPokemonBox=(pokemon)=>{
    const name=pokemon.name[0].toUpperCase()+pokemon.name.slice(1);//ilk harflerini büyük yazdırıyoruz
    const id=pokemon.id.toString().padStart(3,"0");//burda string metodu kullanıyoruz 3 tane harf olsun kalanları 0 ile doldur
